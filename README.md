...
- Pan and zoom each photo in place (drag to move, scroll or +/− to zoom, double-click to reset)
- Flip each photo horizontally or vertically, and rotate 90° clockwise or anti-clockwise
...
4. Fine-tune each photo in place: drag to reposition, scroll or use +/− to zoom, flip or rotate with the on-photo buttons, double-click to reset
